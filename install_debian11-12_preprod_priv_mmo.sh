...
echo "Quel est le nouveau nom complet de la machine ? (format = server1.qualif.dsi.priv.sorbonne-universite.fr)"
read new_hostname
...
echo "Quel est l'adresse du proxy de la machine ? (format = http://10.11.XX.XXX/)"
read new_proxy
