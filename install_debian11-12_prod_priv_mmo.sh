...
echo "Quel est l'adresse du proxy de la machine ? (format = http://10.11.X.XXX/)"
read new_proxy
...
<zone>
  <short>Work</short>
  <description>For use in work areas. You mostly trust the other computers on networks to not harm your computer. Only selected incoming connections are accepted.</description>  <service name="ssh"/>
  <service name="ssh"/>
  <service name="http"/>
  <service name="https"/>
